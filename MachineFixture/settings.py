...
MICRO_SERVICE_PORT = os.getenv('MICRO_SERVICE_PORT', default=8000)
MICRO_SERVICE_NAME = os.getenv('MICRO_SERVICE_NAME')

SPEA_MICRO_SERVICE_PORT = os.getenv('SPEA_MICRO_SERVICE_PORT', default=8000)
SPEA_MICRO_SERVICE_NAME = os.getenv('SPEA_MICRO_SERVICE_NAME')

POLMESPROD_HOST = os.getenv('POLMESPROD_HOST')
POLMESPROD_DATABASE_NAME = os.getenv('POLMESPROD_DATABASE_NAME')
POLMESPROD_USER = os.getenv('POLMESPROD_USER')
POLMESPROD_PASSWORD = os.getenv('POLMESPROD_PASSWORD')
